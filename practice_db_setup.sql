...
-- This version is optimized for SQLite and includes 'DROP TABLE' logic
-- to allow for clean resets.
-- ==============================================================================

-- Enable Foreign Key support (required for relationships to work in SQLite)
PRAGMA foreign_keys = ON;

-- Clean up existing tables (Drop in reverse order of dependencies)
